...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex items-center justify-between mb-8">
        <h1 class="font-alumni text-h4 text-dark">Usuaris</h1>
    </div>
    ...
    <div x-data="bulkSelect('users')">
        @include('admin.partials._bulk_toolbar', ['module' => 'users'])
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($users as $user)
                        ...
                        @endphp
                        <tr class="hover:bg-gray-50 transition-colors" :class="selected.includes({{ $user->id }}) ? 'bg-primary/5' : ''">
                            <td class="px-4 py-4">
                                <input type="checkbox" :value="{{ $user->id }}" x-model="selected" class="rounded accent-primary">
                            </td>
