...
<div class="p-8 space-y-6">
    ...
    <div x-data="bulkSelect('contact_messages')">
        @include('admin.partials._bulk_toolbar', ['module' => 'contact_messages'])
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-light/50 transition-colors" :class="selected.includes({{ $msg->id }}) ? 'bg-primary/5' : ''">
                            <td class="px-4 py-4">
                                <input type="checkbox" :value="{{ $msg->id }}" x-model="selected" class="rounded accent-primary">
                            </td>
                            <td class="px-6 py-4">
