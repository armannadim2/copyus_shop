...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div x-data="bulkSelect('promo_codes')">
        @include('admin.partials._bulk_toolbar', ['module' => 'promo_codes'])
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($codes as $code)
                        <tr class="hover:bg-gray-50 transition-colors" :class="selected.includes({{ $code->id }}) ? 'bg-primary/5' : ''">
                            <td class="px-4 py-3">
                                <input type="checkbox" :value="{{ $code->id }}" x-model="selected" class="rounded accent-primary">
                            </td>
                            <td class="px-5 py-3">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-5 py-12 text-center font-outfit text-sm text-gray-400">
